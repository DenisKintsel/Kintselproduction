...
import 'package:flutterapp2/api_connection/user_api.dart';
import 'package:flutterapp2/dao/user_dao.dart';
import 'package:flutterapp2/model/user_model.dart';
import 'package:flutterapp2/storage/shared_preference.dart';
...
class UserRepository {
  ...
  Future<bool> signIn(String email, String password) async{
    ...
    if(status == 200 && body['error'] == null)
    {
      ...
      User user = User(username: user_bd['username'], email: user_bd['email'], id: user_bd['id']);
