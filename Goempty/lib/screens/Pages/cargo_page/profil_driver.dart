...
class ProfilDriver extends StatelessWidget {
  final User user;
   final  driver;
  ProfilDriver({this.driver,this.user});
  @override
  Widget build(BuildContext context) {
    final Size size = MediaQuery.of(context).size;
     return Scaffold(
      ...
      body: Center(
        child: TextCity(driver:driver,user: user),
      ),
...
class TextCity extends StatelessWidget{
  final User user;
  final driver;
TextCity({this.driver,this.user});
  @override
  Widget build(BuildContext context) {
    String idA = driver['id_user'];
       return Padding(
